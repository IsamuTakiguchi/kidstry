...
ひらがな・かず・とけい・えいご・かたち・ちえ・せいかつしゅうかん・しぜんを、12のミニゲームで楽しく学べます。
...
**③ きんメダル（全12個）— じょうずになると集まる**
次の目標はメダルです。**あそびごとに★3（10問中9問以上を1回目で正解）を取ると1個**もらえます。
12のあそび全部が対象なので、シールが「参加で集まる」のに対し、メダルは「上達すると集まる」設計です。
...
src/
  ...
  data/                 ひらがな・ことば・えいご・きせつ・シールのデータ
  games/                12のあそびの「問題生成関数」（純粋関数）
